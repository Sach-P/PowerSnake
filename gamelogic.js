var canvas, ctx, gameActive, gameControl;
    ...
    document.getElementById("Predator").onclick = function(){
        if(!predator){
            ...
            prey = false;
            classic = false;
            document.getElementById("Predator").style.color = "blueviolet";
            ...
            document.getElementById("top-side1").style.color = "blueviolet";
            document.getElementById("top-side2").style.color = "blueviolet";
